  ...
  <div class="row">
    <div class="col-sm-4">
          <h3>Editar Restaurante</h3>
                <form action="editarrestaurante2.php" method="post">
                  <?php
                         $idrestaurante = $_GET['id'];
                         $sql =<<<EOF
                            SELECT * from urban.restaurante where idrestaurante = $idrestaurante;
EOF;
                      $ret = pg_query($db, $sql);
                      if(!$ret) {
                      ...
                      while($row = pg_fetch_row($ret)) {
                         ...
                         echo "<input type='text' name='linkimagem' id='linkimagem' value='$row[4]'><br>";
                         echo "<p>Nome:</p><br>";
                         ...
                         echo "<input type='hidden' value='$row[5]' name='idcidade' id='idcidade'>";
